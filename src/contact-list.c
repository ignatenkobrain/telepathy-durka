...
durka_contact_list_init (DurkaContactList *self)
{
  self->priv = G_TYPE_INSTANCE_GET_PRIVATE (self,
      DURKA_TYPE_CONTACT_LIST, DurkaContactListPrivate);

  self->priv->contact_details = g_hash_table_new_full (g_direct_hash,
      g_direct_equal, NULL, durka_contact_details_destroy);
...
dispose (GObject *object)
{
  ...
  ((GObjectClass *) durka_contact_list_parent_class)->dispose (
    object);
}
...
next_hash_element:
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_set_contact_groups_async);
}
...
receive_contact_lists (gpointer p)
{
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "sjoerd@durka.com",
      NULL, NULL);
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "guillaume@durka.com",
      NULL, NULL);
  d = ensure_contact (self, handle, NULL);
  g_free (d->alias);
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "olivier@durka.com",
      NULL, NULL);
  d = ensure_contact (self, handle, NULL);
  g_free (d->alias);
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "travis@durka.com",
      NULL, NULL);
  d = ensure_contact (self, handle, NULL);
  g_free (d->alias);
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "geraldine@durka.com",
      NULL, NULL);
  d = ensure_contact (self, handle, NULL);
  g_free (d->alias);
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "helen@durka.com",
      NULL, NULL);
  d = ensure_contact (self, handle, NULL);
  g_free (d->alias);
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "wim@durka.com",
      NULL, NULL);
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "christian@durka.com",
      NULL, NULL);
  tp_handle_set_add (self->priv->contacts, handle);
  g_hash_table_insert (self->priv->publish_requests,
  ...
  handle = tp_handle_ensure (self->priv->contact_repo, "bill@durka.com",
      NULL, NULL);
  tp_handle_set_add (self->priv->blocked_contacts, handle);
  handle = tp_handle_ensure (self->priv->contact_repo, "steve@durka.com",
      NULL, NULL);
  tp_handle_set_add (self->priv->blocked_contacts, handle);
...
send_updated_roster (DurkaContactList *self,
    TpHandle contact)
{
  DurkaContactDetails *d = g_hash_table_lookup (self->priv->contact_details,
      GUINT_TO_POINTER (contact));
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_set_group_members_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_handle_set_destroy (new_contacts);
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_add_to_group_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_remove_from_group_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_request_subscription_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_authorize_publication_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_store_contacts_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_remove_contacts_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_unsubscribe_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_unpublish_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_handle_set_destroy (changed);
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_block_contacts_with_abuse_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_handle_set_destroy (changed);
  tp_simple_async_report_success_in_idle ((GObject *) self, callback,
      user_data, durka_contact_list_unblock_contacts_async);
}

static guint
durka_contact_list_get_group_storage (
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) contact_list, callback,
      user_data, durka_contact_list_remove_group_async);
}
    ...
    gpointer user_data)
{
  ...
  tp_simple_async_report_success_in_idle ((GObject *) contact_list, callback,
      user_data, durka_contact_list_rename_group_async);
}
