...
static void
durka_connection_manager_init (
    DurkaConnectionManager *self)
{
...
{
  DurkaConnectionManager *self =
    DURKA_CONNECTION_MANAGER (object);
  ...
  protocol = g_object_new (DURKA_TYPE_PROTOCOL,
      "name", "vk",
      NULL);
...
static void
durka_connection_manager_class_init (
    DurkaConnectionManagerClass *klass)
{
  ...
  g_type_class_add_private (klass,
      sizeof (DurkaConnectionManagerPrivate));
